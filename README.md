...
![Components](https://raw.githubusercontent.com/biokb/biokb_coconut/refs/heads/main/docs/imgs/components.png)
...
1. Query Coconut data with SQLAlchemy or raw SQL
2. Load, query and manage Coconut data with GUIs for knowledge base and graphs (phpMyAdmin, Neo4J Browser)
...
- imports [Coconut](https://www.ebi.ac.uk/coconut/) data into a relational database 
